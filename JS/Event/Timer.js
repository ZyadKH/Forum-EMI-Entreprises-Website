document.addEventListener('DOMContentLoaded', function () {
    ...
    let endDate = '05/10/2024 00:00:00'; // date format mm/dd/yyyy
    ...
    let x = setInterval(function () {
        ...
        let daysRemaining = Math.floor((distance % (1000 * 60 * 60 * 24 * 30)) / (1000 * 60 * 60 * 24));
        let hoursRemaining = Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
